               ...
               <div id="main-navigation" class="d-none d-lg-block mt-2 mt-lg-0">
                  <ul class="nav-main nav-main-dark nav-main-horizontal nav-main-hover">
                     ...
                     <li class="nav-main-item">
                        <a class="nav-main-link" href="bd_dashboard.html">
                           <i class="nav-main-link-icon si si-compass"></i>
                           <span class="nav-main-link-name">Registro de Atenciones</span>
                        </a>
                     </li>
                     <li class="nav-main-item">
                        <a class="nav-main-link" href="bd_dashboard.html">
                           <i class="nav-main-link-icon si si-compass"></i>
                           <span class="nav-main-link-name">Registro de Actividades</span>
                        </a>
                     </li>
                     <li class="nav-main-item">
                        <a class="nav-main-link" href="bd_dashboard.html">
                           <i class="nav-main-link-icon si si-compass"></i>
                           <span class="nav-main-link-name">Estad&iacute;sticas</span>
                        </a>
                     </li>
