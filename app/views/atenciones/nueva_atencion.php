<div class="content">
   <div class="block block-rounded block-mode-loading-oneui h-100">
      <div class="block-header block-header-default">
         <h3 class="block-title">Hoja de Trabajo N° <?= isset($data['hoja']) ? $data['hoja'] : 0 ?> <small>Nombre Apellido</small></h3>
      </div>
      <div class="block-content block-content-full">
         <form  id="form-atenciones">
         <input type="hidden" name="id_hoja_especialista" id="id_hoja_especialista" value="">
