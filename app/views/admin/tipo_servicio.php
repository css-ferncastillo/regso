         ...
         <div class="block block-rounded block-mode-loading-oneui h-100 mb-2">
            ...
            <div class="block-content block-content-full">
               ...
               <form id="frm_alaboral" action="" method="post">
                  ...
                  <div class="mb-2">
                     <label class="form-label" for="desctipcion">Servicio</label>
                     <input type="text" class="form-control" id="desctipcion" name="desctipcion" placeholder="Servicio">
                  </div>
