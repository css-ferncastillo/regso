         ...
         <div class="block block-rounded block-mode-loading-oneui h-100 mb-2">
            ...
            <div class="block-content block-content-full">
               ...
               <form id="frm_alaboral" action="" method="post">
                  ...
                  <div class="mb-2">
                     <label class="form-label" for="alta_laboral">Alta Laboral</label>
                     <input type="text" class="form-control" id="alta_laboral" name="alta_laboral" placeholder="Alta Laboral">
                  </div>
