         ...
         <form id="frm-nueva-hoja" action="<?= APP_URI ?>hojas/procesar_creacion" method="POST">
            <div class="row g-3 mb-4">
               ...
               <div class="col" id="datetime">
                  ...
                  <input type="text" class="form-control" placeholder="Fecha de Atenci&oacute;n" aria-label="Last name" id="dt_atencion" name="dt_atencion">
               ...
               <div class="col">
                  ...
                  <input type="text" class="form-control" placeholder="Nombre Especialista" aria-label="Last name" id="nombre_profecional" name="nombre_profecional">
            ...
            <div class="row g-3 mb-4">
               <div class="col">
                  ...
                  <select class="form-select" aria-label="Unidad Ejecutora" id="lugar_atencion" name="lugar_atencion">
                     ...
                     <option value="2">Extramuro</option>
                  </select>
               ...
               <div class="col">
                  ...
                  <input type="number" class="form-control" placeholder="Horas Administrativas" aria-label="Last name" id="h_contratadas" name="h_contratadas" min="0" max="24">
               ...
               <div class="col">
                  ...
                  <input type="number" class="form-control" placeholder="Horas Contratadas" id="h_trabajadas" name="h_trabajadas" aria-label="Last name" min="0" max="24">
               ...
               <div class="col">
                  ...
                  <input id="h_administrativas" name="h_administrativas" type="number" class="form-control" placeholder="Horas Utilizadas" aria-label="Last name" min="0" max="24">
            ...
            <div class="row g-3 mb-4">
               <div class="col">
                  ...
                  <input type="number" class="form-control" placeholder="Vacaciones" aria-label="Last name" id="num_vacaciones" name="num_vacaciones">
               </div>
               <div class="col">
                  <label for="num_licencias" class="form-label">Licencias</label>
                  <input type="number" class="form-control" placeholder="Licencias" aria-label="Last name" id="num_licencias" name="num_licencias">
               </div>
               <div class="col">
                  <label for="num_permiso" class="form-label">Permisos</label>
                  <input type="number" class="form-control" placeholder="Permisos" aria-label="Last name" id="num_permiso" name="num_permiso">
               </div>
               <div class="col">
                  <label for="num_incapacidad" class="form-label">Incapacidades</label>
                  <input type="number" class="form-control" placeholder="Incapacidades" aria-label="Last name" id="num_incapacidad" name="num_incapacidad">
               </div>
               <div class="col">
                  <label for="num_fortuitas" class="form-label">Fortuitos</label>
                  <input type="number" class="form-control" placeholder="Fortuitos" aria-label="Last name" id="num_fortuitas" name="num_fortuitas">
               </div>
            </div>
            <!-- ROW 4 -->
            <div class="row g-3 mb-4">
               <div class="col">
                  ...
                  <input type="number" class="form-control" placeholder="Carga Laboral" aria-label="Last name" id="carga_laboral" name="carga_laboral">
               </div>
               <div class="col">
                  <label for="cupo_utilizado" class="form-label">Cupos Utilizados</label>
                  <input type="number" class="form-control" placeholder="Cupos Utilizados" aria-label="Last name" id="cupo_utilizado" name="cupo_utilizado">
               </div>
               <div class="col">
                  <label for="cupo_disponible" class="form-label">Cuppos Disponibles</label>
                  <input type="number" class="form-control" placeholder="Cuppos Disponibles" aria-label="Last name" id="cupo_disponible" name="cupo_disponible">
               </div>
               <div class="col">
                  <label for="cupo_ausente" class="form-label">Cupos No Acudi&oacute;</label>
                  <input type="number" class="form-control" placeholder="Cupos No Acudi&oacute;" aria-label="Last name" id="cupo_ausente" name="cupo_ausente">
               </div>
               <div class="col">
