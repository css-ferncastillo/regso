...
<head>
   ...
   <title>
      OneUI - Bootstrap 5 Admin Template &amp; UI Framework |
   </title>
   ...
   <link rel="stylesheet" id="css-main" href="<?= APP_URI ?>public/assets/css/oneui.min-5.2.css" />
   <link rel="stylesheet" id="css-main" href="<?= APP_URI ?>public/assets/css/animate.min.css" />
</head>
...
<body>
      ...
      <header id="page-header">
         <div class="content-header">
            <div class="d-flex align-items-center">
               <a class="fw-semibold fs-5 tracking-wider text-dual me-3" href="index.html"> CSS<span class="fw-normal">Panam&aacute;</span> </a>
            ...
            <div class="d-flex align-items-center">
               ...
               <div class="dropdown d-inline-block ms-2">
                  <button type="button" class="btn btn-sm btn-alt-secondary" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <img class="rounded" src="<?= APP_URI ?>public/assets/media/avatars/avatar10.jpg" alt="Header Avatar" style="width: 21px;" />
                     <span class="d-none d-sm-inline-block ms-1">John</span>
                     <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                  </button>
                  <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                     <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                        <img class="img-avatar img-avatar48 img-avatar-thumb" src="<?= APP_URI ?>public/assets/media/avatars/avatar10.jpg" alt="">
      ...
      <main id="main-container">
         <div class="bg-primary-darker">
            <div class="content py-3">
               ...
               <div id="main-navigation" class="d-none d-lg-block mt-2 mt-lg-0 animate__animated animate__backInLeft animate__slow">
                  <ul class="nav-main nav-main-dark nav-main-horizontal nav-main-hover">
                     ...
                     <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                           ...
                           <li class="nav-main-item">
                              <a class="nav-main-link active" href="bd_simple_2.html">
                     ...
                     <li class="nav-main-item ms-lg-auto">
                        ...
                        <ul class="nav-main-submenu nav-main-submenu-right">
                           ...
                           <li class="nav-main-item">
                              <a class="nav-main-link" data-toggle="theme" data-theme="<?=APP_URI?>public/assets/css/themes/amethyst.min-5.2.css" href="#">
                                 <i class="nav-main-link-icon fa fa-square text-amethyst"></i>
                                 <span class="nav-main-link-name">Amethyst</span>
                              </a>
                           </li>
                           <li class="nav-main-item">
                              <a class="nav-main-link" data-toggle="theme" data-theme="<?=APP_URI?>public/assets/css/themes/city.min-5.2.css" href="#">
                                 <i class="nav-main-link-icon fa fa-square text-city"></i>
                                 <span class="nav-main-link-name">City</span>
                              </a>
                           </li>
                           <li class="nav-main-item">
                              <a class="nav-main-link" data-toggle="theme" data-theme="<?=APP_URI?>public/assets/css/themes/flat.min-5.2.css" href="#">
                                 <i class="nav-main-link-icon fa fa-square text-flat"></i>
                                 <span class="nav-main-link-name">Flat</span>
                              </a>
                           </li>
                           <li class="nav-main-item">
                              <a class="nav-main-link" data-toggle="theme" data-theme="<?=APP_URI?>public/assets/css/themes/modern.min-5.2.css" href="#">
                                 <i class="nav-main-link-icon fa fa-square text-modern"></i>
                                 <span class="nav-main-link-name">Modern</span>
                              </a>
                           </li>
                           <li class="nav-main-item">
                              <a class="nav-main-link" data-toggle="theme" data-theme="<?=APP_URI?>public/assets/css/themes/smooth.min-5.2.css" href="#">
         ...
         <div class="content py-3">
            <div class="row fs-sm">
               ...
               <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                  <a class="fw-semibold" href="#" target="_blank">OneUI 5.2</a> &copy; <span data-toggle="year-copy"></span>
               </div>
            </div>
         </div>
      </footer>
   ...
   <script src="<?= APP_URI ?>public/assets/js/oneui.app.min-5.2.js"></script>
</body>
